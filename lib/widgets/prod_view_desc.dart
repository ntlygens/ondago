...
class _ProdViewDescState extends State<ProdViewDesc> {
  ...
  Widget build(BuildContext context) {
    // Object isSelected = this.isSelected ?? false;
      ...
      child: Column(
        children: [
          Text(
            ...
            style: TextStyle(
              color: _isSelected ? Colors.black12 : Colors.black45,
              fontSize: 18,
          ...
          Text(
            ...
            style: TextStyle(
              height: 1.1,
              color: _isSelected ? Colors.black12 : Colors.black,
              fontSize: 12,
